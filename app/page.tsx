...
import { Home, Car, Bell, Shield, Users, Smartphone, Star, ChevronDown } from 'lucide-react'
import {
Accordion,
AccordionContent,
AccordionItem,
...
content: '"HAA has completely transformed how I manage my home maintenance and vehicle care. I never miss a service appointment or lose a warranty again! The reminders are a lifesaver."',
rating: 5
},
{
name: 'Mike Rodriguez', 
role: 'Property Manager',
content: '"Managing multiple properties used to be a nightmare. HAA makes it simple to track everything from repairs to warranties across all my units. I\'m never going broke in maintenance!"',
rating: 5
},
{
name: 'Jennifer Chen',
role: 'Busy Professional',
content: '"As someone with a hectic schedule, HAA keeps me organized. The receipt vault and automatic warranty extraction save me hours every month. It\'s like having a personal assistant!"',
rating: 5
}
]
...
answer: 'HAA provides a centralized platform where you can log all maintenance activities, set reminders based on dates or mileage, and track warranties. You\'ll never miss important maintenance again.'
},
{
question: 'Can I upload and store receipts in HAA?',
answer: 'Yes! HAA includes a secure receipts vault where you can upload and store all your purchase receipts and warranty documents. Our system can even auto-extract warranty information.'
},
{
question: 'How does the Service Pro Finder work?',
answer: 'Our Service Pro Finder connects you with local service professionals like electricians, plumbers, and contractors. You can view ratings, read reviews, and contact them directly through the platform.'
},
{
question: 'Is my data secure with HAA?',
answer: 'Absolutely. We use bank-level encryption to protect your data and ensure your personal information and documents are completely secure.'
},
{
question: 'Can I access HAA on my mobile device?',
answer: 'Yes! HAA is fully responsive and works great on all devices. We also offer a Progressive Web App (PWA) for mobile users.'
}
]
...
<div className="min-h-screen bg-white">
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex h-16 items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <Link href="#home" className="text-sm font-medium text-gray-600 hover:text-gray-900">
            Home
          </Link>
        ...
        <div className="flex items-center space-x-4">
          <Link href="/login">
            <Button variant="ghost" className="text-gray-600 hover:bg-[#f1f5f9] hover:text-[#186bbf]">Sign In</Button>
          </Link>
          <Link href="/signup">
  ...
  {/* Hero Section */}
  <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gray-500">
    {/* Background Images */}
    ...
    <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <p className="text-xl text-white mb-4 max-w-2xl mx-auto">
          All your home and vehicle info—safe, searchable, and always up-to-date.
        </p>
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          From property maintenance to vehicle tracking, HAA provides all the tools you need in one organized platform.
        </p>
      </div>
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-16">
        ...
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Born from the frustration of lost warranties, missed maintenance, and scattered paperwork,{' '}
          <span className="text-blue-600">HAA was created by homeowners and vehicle enthusiasts</span>{' '}
          who knew there had to be a better way to stay organized.
        </p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-16 px-3">
        <div>
          <h3 className="text-2xl font-bold text-slate-800 mb-6">Our Story</h3>
          <div className="space-y-4 text-gray-600">
            <p>
              It started with a simple question: "Where did I put that warranty?" After spending countless hours searching through boxes of receipts and folders of documents, our founders realized that managing home and vehicle information shouldn't be this complicated.
            </p>
            <p>
              We built HAA to be the solution we wished existed – a single, secure place where all your property and vehicle information lives, with smart reminders that actually work and data that save you time and money.
            </p>
            <p>
              Today, thousands of homeowners and vehicle owners trust HAA to keep their most valuable assets organized and well-maintained. We're just getting started.
            </p>
          </div>
        </div>

        <div className="flex justify-center">
          <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:rotate-2 transform">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <Card className="text-center p-6 bg-white border border-gray-200 rounded-2xl shadow-sm">
          ...
          <h4 className="font-semibold mb-3 text-slate-800">Our Commitment</h4>
          <p className="text-sm text-gray-600">
  ...
  <section className="py-20 bg-slate-800 text-white">
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
        Get new leads for as low as <span className="text-orange-500 font-semibold">$15/mo</span>. Connect with homeowners and 
        vehicle owners in your area who need your expertise.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
        ...
        <Card className="border border-gray-200 rounded-2xl shadow-sm bg-white">
          <CardContent className="p-8">
            ...
            <ul className="space-y-3 mb-8 text-sm">
              ...
              <li className="flex items-center">
                <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
                <span className="text-gray-700">Receipt storage (50MB)</span>
              </li>
              <li className="flex items-center">
                <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
          ...
          >
            <Card className="border-2 border-orange-500 rounded-2xl relative shadow-lg">
              <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                <Badge className="bg-orange-500 text-white px-4 py-1 rounded-full font-medium">MOST POPULAR</Badge>
              </div>
              <CardContent className="p-8  rounded-2xl bg-[rgba(255,254,253,1)]"> {/* Removed bg-[rgba(255,254,253,1)] from here */}
                <div className="text-center mb-6">
                  <h3 className="text-xl font-semibold mb-2 text-slate-800">Pro Owner</h3>
                  <div className="text-4xl font-bold text-slate-800">$5</div>
                  <p className="text-gray-600">/per month</p>
                  <p className="text-sm text-gray-500 mt-1">For serious property & vehicle owners</p>
                </div>
                <ul className="space-y-3 mb-8 text-sm">
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
                    <span className="text-gray-700">Unlimited properties & vehicles</span>
                  </li>
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
                  ...
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
                    <span className="text-gray-700">Unlimited receipt storage</span>
                  </li>
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
                    <span className="text-gray-700">Service provider booking</span>
                  </li>
                  <li className="flex items-center">
                    <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
        ...
        <Card className="border border-gray-200 rounded-2xl shadow-sm">
          <CardContent className="p-8 bg-white rounded-2xl ">
            <div className="text-center mb-6">
              <h3 className="text-xl font-semibold mb-2 text-slate-800">Provider</h3>
              <div className="text-4xl font-bold text-slate-800">$15</div>
              <p className="text-gray-600">/per month</p>
              <p className="text-sm text-gray-500 mt-1">For service professionals</p>
            </div>
            <ul className="space-y-3 mb-8 text-sm">
              <li className="flex items-center">
                <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
                <span className="text-gray-700">Everything in Pro Owner</span>
              </li>
              <li className="flex items-center">
                <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <div className="flex items-center space-x-2 mb-4">
            <Image src="/logo.svg" alt="HAA" width={32} height={32} />
            <span className="text-xl font-bold">HAA</span>
          </div>
          ...
          <div className="flex space-x-4">
            ...
            <a href="#" className="text-gray-400 hover:text-white">
              ...
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.479 1.492-3.835 3.75-3.835 1.098 0 2.253.194 2.253.194v2.458h-1.538c-1.21 0-1.488.741-1.488 1.49v1.938h2.626l-.405 2.712h-2.22V21.88a9.92 9.92 0 008.41-9.88z" clipRule="evenodd" />
              </svg>
            </a>
            <a href="#" className="text-gray-400 hover:text-white">
              <span className="sr-only">Instagram</span>
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                <path fillRule="evenodd" d="M12 2C7.691 2 4 5.691 4 10v4c0 4.309 3.691 8 8 8s8-3.691 8-8V10c0-4.309-3.691-8-8-8zm0 2c3.314 0 6 2.686 6 6v4c0 3.314-2.686 6-6 6s-6-2.686-6-6V10c0-3.314 2.686-6 6-6zm5.293 3.293a1 1 0 011.414 1.414l-1.414 1.414a1 1 0 01-1.414-1.414l1.414-1.414zm-8.586 0a1 1 0 011.414 0l1.414 1.414a1 1 0 01-1.414 1.414l-1.414-1.414a1 1 0 010-1.414zM12 14a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
              </svg>
            </a>
          </div>
        </div>
